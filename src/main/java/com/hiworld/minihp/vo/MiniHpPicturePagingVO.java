...
public class MiniHpPicturePagingVO {
	/** 한 페이지당 게시글 수 **/
    ...
    public MiniHpPicturePagingVO(int listCnt, int curPage){
	...
	public String toString() {
		return "MiniHpBoardPagingVO [pageSize=" + pageSize + ", rangeSize=" + rangeSize + ", curPage=" + curPage
